...
import NanYueEnvelopeCard from "../Tags/NanYueEnvelope";
    ...
    <main className="relative w-full px-2 py-4 sm:px-4 sm:py-6 lg:px-6">
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col items-center">
        ...
        {articles.map((article) => {
          ...
          if (isNanYue) return <NanYueEnvelopeCard key={article.slug} article={article} onOpen={() => navigate(`/articles/${article.slug}`)} />;
          return (
            <article

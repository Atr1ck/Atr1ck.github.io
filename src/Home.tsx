...
function TopNavi() {
  ...
  return (
      <div className="navbar min-h-16 bg-base-100/90 text-base-content border-b border-base-300/70 shadow-sm rounded-b-lg px-2 md:px-4 backdrop-blur-md transition-colors duration-300">
